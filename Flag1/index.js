...
const pin_hash = "8ded779f3113d74c002fac80d9b1f1a2";
console.log(MD5("763421"));


/*const form = document.querySelector('form[name="pinForm"]');*/
...
form.addEventListener("submit", (e) => {
    ...
    if(MD5(input) === pin_hash){
        verifyQuery(input);
    }else{
        document.getElementById("answer").innerHTML = "Invalid PIN";
    }
});
